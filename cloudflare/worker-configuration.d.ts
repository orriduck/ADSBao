...
interface CloudflareWorkerEnv {
  ...
  VITE_THREE_OSM_RASTER_SOURCE_ID?: string;
  VITE_THREE_OSM_RASTER_URL_TEMPLATE?: string;
  VITE_THREE_OSM_RASTER_ATTRIBUTION?: string;
  VITE_THREE_OSM_RASTER_ATTRIBUTION_URL?: string;
}

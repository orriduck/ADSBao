...
const zhCN = {
  ...
  filters: {
    clearAll: "清除筛选",
    activeCount: "已启用 {count} 项筛选",
    emptyHint: "清除上方筛选或修改搜索，即可查看更多目标。",
  ...
  search: {
    ...
    clear: "清除搜索",
    retry: "重试",
    errorHint: "暂时无法连接机场目录。请重试，或输入机场代码。",
    emptyHint: "试试机场名称、城市、IATA/ICAO 代码或航班呼号。",
    keyboardHint: "↓ ↑ 选择 · Enter 打开 · Esc 返回搜索框",
  ...
  map: {
    ...
    pageLoadingTitle: "正在打开页面…",
    pageLoadingEyebrow: "ADSBao",
    pageLoadFailedTitle: "页面未能打开。",
  ...
  mapSettings: {
    categoryLabel: "设置分类",
    mapCategory: "地图",
    draftHint: "地图、单位和提醒设置将在保存后生效。",
    unsavedChanges: "有未保存的更改 · 取消将放弃更改",
    sessionActionHint: "会话控制 · 立即生效",
    allowNotifications: "允许浏览器通知…",

    title: "地图设置",
    description: "地图显示、读数单位与附近提醒。",
    baseMapSection: "底图",
    layersSection: "显示",
    unitsSection: "单位",
    ...
    savedSettingsAvailable: "已保存在当前设备。",
    savingSettings: "保存中...",
    savedSettings: "已保存",
    save: "保存",
    cancel: "取消",

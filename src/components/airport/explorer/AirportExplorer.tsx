...
function AirportExplorerContent({
  ...
  // Here follows the current GPS fix directly, including after a stationary
  // interval. Aircraft interpolation must not leave the device center stale.
        ...
        >
          ...
          {mapSettingsReadyForUserLocation && airportCoordinatesReady ? (
            <Suspense fallback={<MapLoadingFallback />}>
              ...
              mapInteractionMode={nearMe
                ? AirportMapInteractionMode.UserLocationTracking
                : AirportMapInteractionMode.AirportExploration}
              />
            </Suspense>
          ) : (
            <MapLoadingFallback />

...
const zhCN = {
  ...
  mapSettings: {
    ...
    modeSection: "模式",
    layersSection: "显示",
    guestPrompt: "登录或注册后可保存这套地图模式和图层设置,并在其他设备恢复使用。",
    noSavedSettings: "还没有保存过地图设置。调到合适后可以保存这一套。",
    savedSettingsAvailable: "这个账户已有一套保存的地图设置。",
    saveSettings: "保存设置",
    savingSettings: "保存中...",
    restoreSettings: "恢复",
    restoringSettings: "恢复中...",
    modes: {
      spotting: "看客模式",
      radio: "无线电模式",
      controller: "空域模式",

...
const en = {
  ...
  map: {
    ...
    adsbPositionFeed: "ADS-B position feed",
    weatherFeed: "weather feed",
    airportContext: "airport context",
    runwayProcedures: "runway procedures",
    routeResolver: "route resolver",
    traceArchive: "trace archive",
    ...
    syncingTrackedAircraft: "SYNCING {callsign}",
    loadingMap: "LOADING MAP...",
    loadingTraffic: "LOADING ADS-B TRAFFIC...",
    loadingTrackedAircraft: "LOADING {callsign} POSITION...",
    loadingWeather: "LOADING WEATHER...",
    loadingNearbyAirports: "LOADING NEARBY AIRPORTS...",
    loadingProcedures: "LOADING RUNWAY DATA...",
    loadingRoutes: "LOADING ROUTE LABELS...",
    loadingTrace: "LOADING TRACE...",

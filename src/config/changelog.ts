...
export const CHANGELOG_RECENT: ChangelogEntry[] = [
  {
    ...
    summary: {
      en: "Airport, flight, and first-screen views share one continuous 36px-rail wayfinding system; airport and aircraft map previews keep identity, metrics, and actions compact and unobstructed.",
      zh: "机场、航班与首屏统一采用连续的 36px 导视边；机场与飞机的地图预览以紧凑且无遮挡的方式呈现身份、数据与操作。",
    },
    highlights: [],
  },
  {

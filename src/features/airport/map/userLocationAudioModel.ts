...
const USER_LOCATION_AIRCRAFT_ALERT_RANGE_NM = 6;
export const USER_LOCATION_AIRCRAFT_ALERT_RANGE_METERS =
  USER_LOCATION_AIRCRAFT_ALERT_RANGE_NM * 1852;
const USER_LOCATION_AIRCRAFT_MIN_INTERVAL_MS = 360;
const USER_LOCATION_AIRCRAFT_MAX_INTERVAL_MS = 2400;
const USER_LOCATION_AIRCRAFT_MIN_TONE_HZ = 620;
const USER_LOCATION_AIRCRAFT_MAX_TONE_HZ = 1120;

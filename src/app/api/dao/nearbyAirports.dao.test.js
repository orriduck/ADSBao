...
assert.equal(
  ...
  "nearby-airports-v5:US:5000:KJFK:40.639928:-73.778692:30:6",
);

{
  ...
  const payload = await cache.read("nearby-airports-v5:US:5000:KJFK:40.639928:-73.778692:30:6");
  ...
  assert.deepEqual(
    ...
    [
      ...
      { type: "select", columns: "response,expires_at" },
      {
        type: "eq",
        column: "cache_key",
        value: "nearby-airports-v5:US:5000:KJFK:40.639928:-73.778692:30:6",
      },
...

{
  ...
  await cache.write({
    cacheKey: "nearby-airports-v5:US:5000:KJFK:40.639928:-73.778692:30:6",
    query: {
      country: "US",
      minRunwayLength: 5000,
      icao: "KJFK",
  ...
  assert.equal(upsertCall.row.cache_key, "nearby-airports-v5:US:5000:KJFK:40.639928:-73.778692:30:6");

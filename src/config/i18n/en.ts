...
const en = {
  ...
  sidebar: {
    ...
    searchPlaceholder: "Search callsign or ICAO",
    ...
    atc: "ATC",
    atcPanel: {
      title: "ATC frequencies · MHz",
      channels: "{count} channels",
      liveAtc: "Search {icao} on LiveATC",
      empty: "No published frequencies for this airport.",
      clearance: "Clearance",
      ground: "Ground",
      tower: "Tower",
      approach: "Approach",
  ...
  filters: {
    ...
    emptyHint: "Clear filters above or change your search to see more targets.",

    aircraftFilterAria: "Filter by aircraft type",
    altitudeFilterAria: "Filter by altitude level",
    airborneFilterAria: "Filter by airborne or ground status",
  ...
  search: {
    browse: "Browse airports",
    clear: "Clear search",
    retry: "Try again",
    errorHint: "The airport directory couldn't be reached. Try again or use an airport code.",
    emptyHint: "Try an airport name, city, IATA/ICAO code, or flight callsign.",
    keyboardHint: "↓ ↑ choose · Enter open · Esc back to search",
    ...
    discovery: {
      network: {
        ...
        hint: "Choose an airport to open its live map.",
        open: "Open {airport}",
      },
      pageTitle: "Airports",
  ...
  map: {
    ...
    nearbyBoundaryTitle: "Map kept within nearby traffic",
    nearbyBoundaryDescription: "This view can move up to {radius} NM from the airport.",
    ...
    pageLoadingTitle: "Opening page…",
    pageLoadingEyebrow: "ADSBao",
    pageLoadFailedTitle: "This page could not open.",
    ...
    routeLoadFailedTitle: "Flight tracking could not open.",
    routeLoadFailedHint: "Refresh to load the latest version and try again.",
    routeLoadRetry: "Refresh",
    flightNoPositionTitle: "No live position",
    flightNoPositionSubtext: "{callsign} isn't broadcasting a position right now.",
    flightSignalLostTitle: "Signal lost",
    flightSignalLostSubtext: "Lost the live signal for {callsign}.",
    flightTerminalTitle: "Flight ended",
    flightTerminalSubtext: "{callsign} has landed or is no longer active.",
  ...
  mapSettings: {
    ...
    mapCategory: "Map",
    draftHint: "Map, unit and alert changes apply when you save.",
    unsavedChanges: "Unsaved changes · Cancel to discard",
    sessionActionHint: "Session control · applies immediately",
    allowNotifications: "Allow browser notifications…",

    title: "Map settings",
    description: "Map display, reading units and nearby alerts.",
    ...
    savedSettingsAvailable: "Saved on this device.",

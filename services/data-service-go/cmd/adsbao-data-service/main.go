...
import (
	...
	"github.com/adsbao/adsbao/services/data-service-go/internal/config"
	"github.com/adsbao/adsbao/services/data-service-go/internal/httpapi"
	"github.com/adsbao/adsbao/services/data-service-go/internal/metrics"
	"github.com/adsbao/adsbao/services/data-service-go/internal/providers/adsb"
	"github.com/adsbao/adsbao/services/data-service-go/internal/providers/flightaware"
	"github.com/adsbao/adsbao/services/data-service-go/internal/providers/route"
	"github.com/adsbao/adsbao/services/data-service-go/internal/realtime"
	"github.com/adsbao/adsbao/services/data-service-go/internal/scheduler"
	"github.com/adsbao/adsbao/services/data-service-go/internal/ws"
)
...
func main() {
	...
	defer stop()
	go func() {
		log.Printf("adsbao-data-service-go listening on :%d", cfg.Port)

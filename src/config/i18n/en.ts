...
const en = {
  ...
  map: {
    ...
    poc: {
      ...
      selectableContextListAria: "Selectable map context",
      ...
      acceptanceWakeLockStatus: "Screen awake · {status} · helper, not a gate",
      acceptanceWakeLockUnsupported: "unsupported",
      acceptanceWakeLockInactive: "inactive",
      acceptanceWakeLockPending: "requesting",
      acceptanceWakeLockActive: "active",
      acceptanceWakeLockError: "request failed",
      acceptanceWakeLockEnable: "Keep screen awake",
      acceptanceWakeLockDisable: "Allow screen sleep",
      acceptanceWakeLockRetry: "Retry screen awake",
      acceptancePhysicalIPhone: "Physical iPhone",
      acceptanceThermalOk: "Thermal OK",
      acceptanceThermalHot: "Too hot",
      acceptanceThermalLocked: "Thermal check unlocks after 20:00",
      acceptanceExport: "Export report",
      acceptanceReset: "Reset report",
      acceptanceResetConfirm: "Confirm reset",
      acceptanceExportState: "Report {state}",
      acceptanceGateDetails: "Gate details · {failed} failed · {pending} waiting",
      acceptanceGateDuration: "Duration",
      acceptanceGatePhysicalIPhone: "Physical iPhone",
      ...
      acceptanceGateRenderStability: "Render stability",
      acceptanceGateThermal: "Device thermal",
    },
  },
  mapLayers: {

...

{
  ...
  assert.equal(result.position.flight_position_source, "flightaware");
  assert.equal(result.position.quality.source, "flightaware");
  assert.equal(result.position.quality.flight_position_source, "flightaware");
...
console.log("flightAwareFallbackProvider.test.ts ok");

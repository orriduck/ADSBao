...
const airportMarkerPath = fileURLToPath(
  new URL("./AirportMarker.tsx", import.meta.url),
);
const source = readFileSync(airportMapPath, "utf8");
const airportMarkerSource = readFileSync(airportMarkerPath, "utf8");
...
assert.doesNotMatch(
  airportMarkerSource,
  /key: "rwy"/,
  "focal airport marker should not show a runway-count badge",
);

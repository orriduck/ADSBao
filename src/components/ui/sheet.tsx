...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg soft-sheet-motion data-[state=open]:animate-in data-[state=closed]:animate-out motion-reduce:animate-none motion-reduce:transition-none",
  {
    variants: {
      side: {

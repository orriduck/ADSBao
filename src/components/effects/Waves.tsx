...
// Perlin noise driving a grid of mouse-reactive flowing lines. Adapted
// from reactbits.dev/backgrounds/waves to JavaScript and keyed to the
// existing canvas background through Tailwind classes.
...
export default function Waves({
  ...
  return (
    <div
      ...
      className={`absolute top-0 left-0 w-full h-full overflow-hidden ${className}`.trim()}
    >
      <div
        className="absolute top-0 left-0 rounded-full w-[0.5rem] h-[0.5rem] bg-atc-text/40"
        style={{
          transform:
